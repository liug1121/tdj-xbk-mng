...
export default {
    ...
    exportCardOrders: params => {
        return API.POST('/bigflow/manage/v1.0/card/orders/export', params)
      },
    ...
    exportBigflowStocks:params =>{
        return API.POST('/bigflow/manage/v1.0/bigflowcardstocks/export', params)
    },
    ...
    importLogisticOrder2Channel: params =>{
        return API.POST('/bigflow/manage/v1.0/logistic/order/channel/import', params, {
            headers: {
                'content-type': 'multipart/form-data'
              }
        })
    ...
    modifyAmountProduct: params =>{
        return API.POST('/bigflow/manage/v1.0/bigflowproducts/amountpool/modify', params)
    },
    removeProduct: params =>{
        return API.POST('/bigflow/manage/v1.0/bigflowproducts/remove', params)
    },
    getAmountPoolProducts: params =>{
        return API.GET('/bigflow/manage/v1.0/amountPool/products', params)
    },
    ...
    exportAmountPoolBills: params =>{
        return API.POST('/bigflow/manage/v1.0/amountPool/pools/bills/export', params)
    },
