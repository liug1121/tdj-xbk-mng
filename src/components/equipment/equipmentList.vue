    ...
    <el-card class="all_list">
      ...
      <div class="button_content">
        <!-- <div v-permission="{indentity:'xbkEquipmentList-lock'}"> -->
          <el-button v-if="selectListNumber !==1" size="medium" type="primary" icon="el-icon-edit" disabled v-permission="{indentity:'xbkEquipmentList-lock'}">机卡锁定</el-button>
        <el-button v-else size="medium" type="primary" icon="el-icon-edit" @click="StatusModify(0)" v-permission="{indentity:'xbkEquipmentList-lock'}">机卡锁定</el-button>
        <!-- </div> -->
        
        <!-- <div v-permission="{indentity:'xbkEquipmentList-unlock'}"> -->
          <el-button v-if="selectListNumber !==1" size="medium" type="primary" icon="el-icon-edit" disabled v-permission="{indentity:'xbkEquipmentList-unlock'}">机卡解锁</el-button>
          <el-button v-else size="medium" type="primary" icon="el-icon-edit" @click="StatusModify(1)" v-permission="{indentity:'xbkEquipmentList-unlock'}">机卡解锁</el-button>
        <!-- </div> -->

        <!-- <div v-permission="{indentity:'xbkEquipmentList-lockArea'}"> -->
          <el-button v-if="selectListNumber !==1" size="medium" type="primary" icon="el-icon-edit" disabled v-permission="{indentity:'xbkEquipmentList-lockArea'}">锁小区</el-button>
          <el-button v-else size="medium" type="primary" icon="el-icon-edit" @click="StatusModify(2)" v-permission="{indentity:'xbkEquipmentList-lockArea'}">锁小区</el-button>
        <!-- </div> -->
        <!-- <div v-permission="{indentity:'xbkEquipmentList-unlockArea'}"> -->
          <el-button v-if="selectListNumber !==1" size="medium" type="primary" icon="el-icon-edit" disabled v-permission="{indentity:'xbkEquipmentList-unlockArea'}">解锁小区</el-button>
          <el-button v-else size="medium" type="primary" icon="el-icon-edit" @click="StatusModify(3)" v-permission="{indentity:'xbkEquipmentList-unlockArea'}">解锁小区</el-button>
        <!-- </div> -->
        <!-- managerType 超强管理员 -->
