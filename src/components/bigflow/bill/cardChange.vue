<template>
  <div class="box_subject">
    <el-card class="all_list">
      ...
      <el-table v-loading="loading" :data="cardChanges" border max-height="600" align="center" :cell-style="{height: '38px',padding:0}" @selection-change="handleSelectionChange">
...
export default {
  ...
  data () {
    ...
    cardChanges:[],
      ...
      // 列表，标题、字段
      table_column: [
        { prop: 'id', label: '流水ID', width: 200, fixed: 'left', sortable: true },
        { prop: 'typeName', label: '消费类型', width: 190, fixed: 'left', sortable: true },
        { prop: 'amount', label: '消费金额', width: 200, sortable: true },
        { prop: 'productCodeName', label: '产品', width: 150, sortable: true },
        { prop: 'phoneNumber', label: '卡号码', width: 300, sortable: true },
        { prop: 'iccid', label: 'ICCID', width: 200, sortable: true },
        { prop: 'cardTypeName', label: '卡类型', width: 180, sortable: true },
        { prop: 'statusName', label: '状态', width: 180, sortable: true },
        { prop: 'payOutId', label: '支付订单号', width: 180, sortable: true },
        { prop: 'saleChannelName', label: '渠道', width: 180, sortable: true },
        { prop: 'salePoint', label: '销售网点', width: 180, sortable: true },
        { prop: 'salePersonName', label: '销售员', width: 180, sortable: true },
        { prop: 'payOrderId', label: '订单编号', width: 180, sortable: true },
        { prop: 'supplierName', label: '运营商', width: 180, sortable: true },
        { prop: 'chargeSceneName', label: '首充/续充', width: 180, sortable: true },
        { prop: 'gmtCharge', label: '销售时间', width: 180, sortable: true }
      ],
    };
  },
  mounted () {
